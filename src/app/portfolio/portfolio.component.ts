...
export class PortfolioComponent implements OnInit {
  ...
  public livetests: string[] = ['https://patrick-kolodziej.developerakademie.net/join/src/index.html', 'http://patrick-kolodziej.developerakademie.net/El%20Pollo%20Loco/index.html','https://patrick-kolodziej.developerakademie.net/simple-crm/index.html'
    ,'https://patrick-kolodziej.developerakademie.net/Pokedex%202/index.html'];
  public github: string[] = ['https://github.com/PatrickKolo/Join', 'https://github.com/PatrickKolo/El-Pollo-Loco', 'https://github.com/PatrickKolo/simple-crm', 'https://github.com/PatrickKolo/Pokedex'];
